...
table_save_path <- here::here("data/decadal_variability_data")

write_csv(laa_table_byyr, str_c(table_save_path, "Annual_mean_length_at_age.csv"))
write_csv(waa_table_byyr, str_c(table_save_path, "Annual_mean_weight_at_age.csv"))